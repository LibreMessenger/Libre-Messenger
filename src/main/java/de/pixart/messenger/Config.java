...
public final class Config {
    ...
    public static final boolean PUSH_MODE = false; 	//closes the tcp connection when going to background and after PING_MIN_INTERVAL of inactivity very experimental. only enable this if you want to around with GCM push
